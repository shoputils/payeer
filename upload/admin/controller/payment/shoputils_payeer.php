...
class ControllerPaymentShoputilsPayeer extends Controller {
    ...
    public function index() {
        ...
        $data = $this->_setData(array(
            ...
            'action'                   => $this->makeUrl('payment/shoputils_payeer'),
            'cancel'                   => $this->makeUrl('extension/payment'),
            'clear_log'                => $this->makeUrl('payment/shoputils_payeer/clearLog'),
            ...
            'text_success_url'         => HTTPS_CATALOG . 'index.php?route=payment/shoputils_payeer/success',
            'text_fail_url'            => HTTPS_CATALOG . 'index.php?route=payment/shoputils_payeer/fail',
            'text_status_url'          => HTTPS_CATALOG . 'index.php?route=payment/shoputils_payeer/status',
        ...
        $data['breadcrumbs'][] = array(
           'href'      => $this->makeUrl('payment/shoputils_payeer'),
        ...
        $this->response->setOutput($this->load->view('payment/shoputils_payeer.tpl', $data));
    }
    ...
    protected function getListHelper() {
        ...
        return $this->load->view('payment/shoputils_payeer_list_helper.tpl', $data);
    }
    ...
    protected function validatePermission() {
        return $this->user->hasPermission('modify', 'payment/shoputils_payeer');
    }
    ...
    function licShutdownHandler() {
        if (@is_array($e = @error_get_last())) {
            ...
            if(($code > 0) && strpos($msg, 'requires a license file')) {
                ...
                $this->response->redirect($this->url->link('payment/shoputils_payeer/lic', '&token=' . $this->session->data['token'], 'SSL'));
            }
        }
    }
